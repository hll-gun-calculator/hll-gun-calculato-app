      ...
      case TimeWidgetType.convert:
        if (d.inDays == 0) {
          ...
          if (d.inSeconds >= 0 && d.inSeconds <= 60) {
            // 60秒内
            return FlutterI18n.translate(context, "basic.time.seconds", translationParams: {
              "s": d.inSeconds.toString(),
            });
          } else if (d.inSeconds > 60 && d.inMinutes <= 1) {
            // 一分钟内
            return FlutterI18n.translate(context, "basic.time.minutes", translationParams: {
          ...
          return FlutterI18n.translate(context, "basic.time.today");
        } else if (d.inDays == 1) {
          return FlutterI18n.translate(context, "basic.time.yesterday");
        } else if (d.inDays == 2) {
          return FlutterI18n.translate(context, "basic.time.beforeYesterday");
        } else if (d.inDays >= 3 && d.inDays <= 7) {
          return FlutterI18n.translate(context, "basic.time.dayAgo", translationParams: {"s": d.inDays.toString()});
        }
        break;
