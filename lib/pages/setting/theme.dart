        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              // 自动
              ListTile(
                title: Text(FlutterI18n.translate(context, "basic.function.auto.title")),
                subtitle: Text(FlutterI18n.translate(context, "basic.function.auto.describe")),
                trailing: Switch(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ListTile(
                      title: Text(FlutterI18n.translate(context, "setting.theme.textScaleFactor")),
                      trailing: Text(fromData["textScaleFactor"].toString()),
                    ),
                    Slider(
